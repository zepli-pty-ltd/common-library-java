...
public final class SignedContainerProfileUtil {
     ...
     *
     * @deprecated Use the CertificateValidator implementation
     */
    public static final CertificateVerifier NULL_CERTIFICATE_VERIFIER = new CertificateVerifier() {
        /**
         * Verify the certificate.
         * @param certificate The certificate to verify.
         * @deprecated Use CertificateValidator.validate() instead.
         */
        @Override
    ...
    /**
     * CertificateValidator instance to sign/verify signed data. Validation ignored with an assumption that the certificates
     * under test are valid. <b>MUST INCLUDE VALIDATION CODE FOR PRODUCTION PURPOSE</b>
     */
    public static final CertificateValidator NULL_CERTIFICATE_VALIDATOR = new CertificateValidator() {

        @Override
        public void validate(X509Certificate arg0) {
            // Do nothing. Implement this method for production code.
        }
    };
    ...
    public static Document getSignedPayload(final String sensitivePayload, final X509Certificate signingCert,
                                            final PrivateKey signingPrivateKey) throws XspException {
        ...
        List<X500PrivateCredential> certificateKeyPairs = new ArrayList<>();
        certificateKeyPairs.add(new X500PrivateCredential(signingCert,
                signingPrivateKey));
     ...
     *
     * @param signedDocument The signed payload to extract data/payload from.
    ...
    public static boolean verifySignature(
        ...
        } catch (XspException | CertificateValidationException e) {
     ...
     *
     * @param signedDocument       the signed document
     * @param certificateValidator the certificate validator implementation to be used to verify the certificate used
     *                             to verify the signature.
     * @return the payload as {@link Document}
     */
    public static boolean verifySignature(
